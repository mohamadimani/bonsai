            ...
            <div class="row">
                <div class="col-sm-12 col-md-8">
                    <div class="card-box">
                        ...
                        <form action="<?= SITE_URL ?>users/update_password"
                              method="post"
                            ...
                            <div class="m-t-20">
                                <h5><b> رمز ورود جدید</b><span>(حداقل 6 کاراکتر)</span></h5>
                                <input minlength="6" required type="password" name="new_password" class="form-control"
                                       id="thresholdconfig" value=""/>
                            </div>
                            <div class="m-t-20">
                                <h5><b>تکرار رمز ورود جدید</b></h5>
                                <input minlength="6" required type="password" name="re_new_password"
                                       class="form-control"
                                       id="thresholdconfig" value=""/>
                            </div>
                            <div class="m-t-20">
