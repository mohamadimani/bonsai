...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">گالری مشتریان</h4>
            ...
            <div class="row port m-t-20 m-b-20">
                <div class="portfolioContainer ">
                    <div class="col-sm-12 col-xs-12  col-md-6 webdesign illustrator">
                        <form action="<?= SITE_URL ?>admin_clients_gallery/upload_gallery" method="post"
                    ...
                    foreach ($gallery as $row) { ?>
                        <div class="col-sm-6 col-lg-3 m-t-20 col-md-4 webdesign illustrator">
                            <div class="gal-detail box ">
                                ...
                                <img src="<?= SITE_URL ?>public/images/clients/<?= $row['img_name'] ?>"
                                     class="thumb-img" alt="<?= $row['alt'] ?>"
                                     style="width: 100%;height: 150px!important;">
                                <br>
                                <br>
                                <div>
                                    <label class="col-sm-6 control-label" for="m1">نام مشتری</label>
                                    <div class="">
                                        <input id="m1" onblur="set_link(this,<?= $row['id'] ?>)" type="text"
                                               class="input-sm form-control" name="link" value="<?= $row['name'] ?>">
                                    </div>
                                </div>

                                <div>
                                    <label class="col-sm-6 control-label" for="m2">توضیحات</label>
                                    <div class="">
                                        <input id="m2" onblur="set_alt(this,<?= $row['id'] ?>)" type="text"
                                               class="input-sm form-control" name="alt" value="<?= $row['text'] ?>">
                                    </div>
                                </div>
...
//            var cat_id = $(item).val();
//            var url = "<?//= SITE_URL ?>//admin_clients_gallery/update_category";
...
//        }
        ...
        function set_check(item, id) {
            ...
            var url = "<?= SITE_URL ?>admin_clients_gallery/save_change";
        ...
        function set_link(item, id) {
            ...
            var url = "<?= SITE_URL ?>admin_clients_gallery/set_link";
        ...
        function set_alt(item, id) {
            var item_value = $(item).val();
            var url = "<?= SITE_URL ?>admin_clients_gallery/set_alt";
            var data = {"value": item_value, "id": id};
            $.post(url, data, function (msg) {
                if (msg == true) {
        ...
        function delete_img(id, item) {
            var url = "<?= SITE_URL ?>admin_clients_gallery/delete_img";
            var data = {"id": id};
            $.post(url, data, function (msg) {
                if (msg == true) {
