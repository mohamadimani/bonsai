                    ...
                    <form method="post"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card-box">
                                    <?php
                                    if (!empty($_SESSION["update_product"]) and $_SESSION["update_product"] == "price") {
                                        ?>
                                    ...
                                    <?php }
                                    if (!empty($_SESSION["update_product"]) and $_SESSION["update_product"] == "danger") {
                                        ?>
                                    ...
                                    <?php }
                                    if (!empty($_SESSION["update_product"]) and $_SESSION["update_product"] == "empty") {
                                        ?>
                                        <div class="alert alert-warning alert-dismissable text-center">
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
                                                ×
                                    ...
                                    <div class="form-group m-b-20">
                                        ...
                                        <input required type="number" name="pro_count" class="form-control"
                                               placeholder="تعداد موجودی" value="<?= @$product["pro_count"] ?>">
                                    </div>
                                    <div class="form-group m-b-20">
