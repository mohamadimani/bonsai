                        ...
                        <div class="col-lg-8">
                            <div class="card-box">
                                ...
                                <form action="<?= SITE_URL ?>admin_posts/update_post/<?= $site_post['id'] . "/" . $site_post['category'] ?>"
                                    ...
                                    <div class="form-group m-b-20">
                                        <label>آیکون پست(تصویر) <span class="text-danger">*</span></label>
                                        <input required type="text" class="form-control" placeholder=" آیکون پست"
                                               name="post_icon" value="<?= $site_post["post_icon"] ?>">
                                    </div>
