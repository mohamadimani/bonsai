...
<div class="row">
    <div class="col-sm-8 col-xs-8 col-sm-push-3 col-xs-push-3">
        <div class="card-box">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="m-t-0 header-title pull-left"><b> افزودن اعضاء  </b></h4>
...
<div class="row">
    <div class="col-sm-8 col-sm-push-3 col-xs-8 col-xs-push-3 ">
        <div class="card-box">
            ...
            <?php }
            if (!empty($_SESSION["add_student"]) and $_SESSION["add_student"] == "server") {
                ?>
            ...
            <?php }
            if (!empty($_SESSION["add_student"]) and $_SESSION["add_student"] == "empty") {
                ?>
            ...
            <?php }
            if (!empty($_SESSION["add_student"]) and $_SESSION["add_student"] == "re_password") {
                ?>
                <div class="alert alert-warning alert-dismissable text-center">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
                        ×
            ...
            <?php }
            if (!empty($_SESSION["add_student"]) and $_SESSION["add_student"] == "is_user_name") {
                ?>
                <div class="alert alert-warning alert-dismissable text-center">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
                        ×
            ...
            if (isset($_SESSION["add_student_info"])) {
                $old_data = $_SESSION["add_student_info"];
                unset($_SESSION["add_student_info"]);
            }
            ?>
            ...
            <div class="table-responsive">
                ...
                <div id="ticketmodal-content">
                    <form action="<?= SITE_URL ?>admin_student/add_new_student" method="post">
                        <div class="col-xs-12">
                            <div class="row">
                                <div class="col-xs-4">
                                    نام کاربری
                                ...
                                <div class="col-xs-8">
                                    <input required data-toggle="tooltip" data-placement="top" title="" type="text"
                                           id="username"
                                           name="user_name" class="form-control" value="<?= @$old_data["user_name"] ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <input required data-toggle="tooltip" data-placement="top" title="" type="password"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <input required data-toggle="tooltip" data-placement="top" title="" type="text"
                                           id="birthdateshow" name="birth_date" class="form-control time usage"
                                           data-original-title="تاریخ تولد" value="">
                                    <script>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <input required data-toggle="tooltip" data-placement="top" title="" type="text"
                                           id="nationalcode" name="national_code" class="form-control"
                                           value="<?= @$old_data["national_code"] ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    <input required data-toggle="tooltip" data-placement="top" title="" type="text"
                                           id="ostan" value="<?= @$old_data["ostan"] ?>"
                                           name="ostan" class="form-control" data-original-title="استان">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-4">
