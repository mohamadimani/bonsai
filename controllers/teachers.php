...
class teachers extends controller
{
    ...
    {
        if (isset($_COOKIE['teacher']) and isset($_SESSION['teacher']) and $_COOKIE['teacher'] == $_SESSION['teacher']) {
            header("location:" . SITE_URL . "teachers");
        } else {
            $data = [];
            $this->teacher_view('login', $data);
        }
    }
    ...
    function index()
    {
        if (isset($_COOKIE['teacher']) and isset($_SESSION['teacher']) and $_COOKIE['teacher'] == $_SESSION['teacher']) {
            ...
            $this->teacher_view('user_info', $data);
        } else {
            header("location:" . SITE_URL . "teachers/teacher_login");
        }
    }
