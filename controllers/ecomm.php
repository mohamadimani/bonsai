...
class ecomm extends controller
{
    ...
    function index($cat_id = "")
    {
        ...
        $data = [
            ...
            "top_view_products" => $top_view_products,
            "ecomm_category" => $ecomm_category,
            "products" => $products,
        ];
        $this->view('web/products', $data);
    }
    ...
    function product($product_id = "")
    {
        ...
        $more_products = $this->model->get_more_products($product_id);
        $data = [
